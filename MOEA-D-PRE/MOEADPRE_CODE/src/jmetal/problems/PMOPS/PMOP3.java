 ...
 */
public class PMOP3 extends Problem { 
  ...
  */
  public PMOP3(String solutionType) throws ClassNotFoundException {
...
//    this(solutionType, 14,10);//(7,3)
   ...
   */
  public PMOP3(String solutionType, 
  ...
  */    
  public void evaluate(Solution solution) throws JMException {
    ...
    double k_=0.0;
    int A=5,B=1,S=-1; // in knee function
    int P=1; // in underlying shape function
