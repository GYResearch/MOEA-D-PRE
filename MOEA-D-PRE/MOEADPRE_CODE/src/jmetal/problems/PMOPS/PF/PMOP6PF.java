 ...
 */
public class PMOP6PF extends Problem {
	/**
	 ...
	 */
	public PMOP6PF(String solutionType) throws ClassNotFoundException {
	 ...
	 */
	public PMOP6PF(String solutionType, Integer numberOfVariables, Integer numberOfObjectives)
			throws ClassNotFoundException {
	...
	public void evaluate(Solution solution) throws JMException {
		...
		k_ = 0.1 * k_ / (0.1 * (numberOfObjectives_ - 1)); //  k_6
