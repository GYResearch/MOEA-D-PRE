 ...
 */
public class PMOP14PF extends Problem {
	/**
	 ...
	 */
	public PMOP14PF(String solutionType) throws ClassNotFoundException {
	 ...
	 */
	public PMOP14PF(String solutionType, Integer numberOfVariables, Integer numberOfObjectives)
			throws ClassNotFoundException {
	...
	public void evaluate(Solution solution) throws JMException {
	    ...
	    for(int i=0;i<numberOfObjectives_-2;i++){// knee function k_3 with degeneration (m-2 variables)
