 ...
 */
public class PMOP10 extends Problem {
	 ...
	 */
	public PMOP10(String solutionType) throws ClassNotFoundException {
//		 this(solutionType, 7,2);
	 ...
	 */
	public PMOP10(String solutionType, Integer numberOfVariables, Integer numberOfObjectives)
			throws ClassNotFoundException {
	...
	public void evaluate(Solution solution) throws JMException {
		...
		double k_=0.0;
	    int A=6,B=1,S=2,l=6; // in knee function  l>=3
	    int P=1; // in underlying shape function
